    ...
    <body>
        <div class="container text-center">
            ...
            <?php
                ...
                $resultado = mostrarDispositivoAlterar($_GET["codigo"]);
            ...
            <form method="POST" action="../controlDispositivos/controleDispositivos.php">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="nome" name="nomDisp" value="<?=$info["nomDisp"]?>">
                    </div>
                    <div class="col">
                        <label for="endereco" class="form-label">Endereço MAC:</label>
                        <input type="text" class="form-control" id="MAC" name="enderecoMAC" value="<?=$info["endMAC"]?>">
                    </div>
                    </div class="mt-4">
                        <button type="submit" class="btn btn-primary" name="opcao" value="alterar" style="width: 20%; margin-top: 2%;">Alterar</button>
                        <button type="submit" class="btn btn-danger" name="opcao" value="excluir" style="width: 20%; margin-top: 2%;">Excluir</button>
                    </div>
                    <input type="hidden" name="codDisp" value="<?=$info["codDisp"]?>">
                </div>
            </form>
        </div>
        <script
